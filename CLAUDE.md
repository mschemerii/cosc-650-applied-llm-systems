...
ChatGPT was used for scaffolding and debugging support, rubric/compliance review, and wording edits for the Week 2 inference-and-sampling notebook. The numerical measurements in the notebook were generated by the locally executed `distilgpt2` model, not supplied by ChatGPT. The final parameter choices, interpretation of the measured results, failure analysis, and submission decisions are reviewed and owned by the student.
